...
export default function ProductDiscover() {
    return (
        <div className='relative aspect-auto  max-w-[1920px] h-[600px] sm:h-[700px] md:h-[800px] lg:h-[1050px]'>
            ...
            <div className='  absolute  left-0 right-8 bottom-1 flex flex-row'>
                <div className='w-full h-[400px] md:h-[500px]  lg:h-[600px] flex flex-row items-end bg-transparent pl-10'>
                    <div className=' max-w-[600px] mt-auto text-wrap overflow-hidden '>
                        ...
                        <p className=' text-sm sm:text-base md:text-lg text-wrap mt-2 max-w-[500px] text-charcoal_black font-semibold'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nihil deserunt id quod ducimus consequatur rem sunt cum, dolorum fugiat sit quasi fuga quo doloribus laboriosam dolores unde, adipisci ullam vero?</p>
                    </div>
                </div>
                <div className=' w-[440px]  sm:w-[490px] md:w-[590px] lg:w-[680px] rounded-2xl h-[400px] md:h-[500px]  lg:h-[600px] overflow-hidden bg-pink-200 relative'>
