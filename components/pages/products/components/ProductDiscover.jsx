      ...
      >
        ...
        <div className="absolute top-0 bottom-0 left-0 right-0 w-full h-full flex flex-row items-center pl-7 lg:pl-10">
          <div className="flex flex-col text-wrap">
            ...
            >
              Discover Diabivita, our innovative supplement designed
              specifically for maintaining healthy blood sugar levels. With a
              blend of natural ingredients, it supports your journey towards
              optimal wellness.
            </motion.p>
          </div>
        </div>
        ...
        <div className="w-full h-[330px] sm:h-[400px] md:h-[500px] lg:h-[600px] flex flex-row items-end bg-transparent pl-3 sm:pl-5 ms:pl-8 lg:pl-10">
          ...
          >
            ...
            <p className="line-clamp-5 md:line-clamp-none text-xs sm:text-base md:text-lg text-wrap mt-2 max-w-[500px] text-charcoal_black font-semibold">
              Transform your daily wellness routine with Diabivita. Our
              carefully formulated supplement integrates seamlessly into your
              lifestyle, providing essential support for blood sugar management
