...
export default function PurposeAndTrust() {
    return (
      <motion.div
        ...
        className="flex flex-col w-full gap-10 pb-14"
      >
        {/* Header */}
        <motion.div
        ...
        >
          <h2 className="text-4xl text-dark_jungle_green font-medium">
            Built with <span className="italic font-semibold">Purpose</span>, Backed by{' '}
            <span className="italic font-semibold">Trust</span>
          </h2>
        </motion.div>
