            ...
            <div className=' relative w-full max-h-[550px] overflow-hidden'>
                ...
                <div className='absolute top-0 bottom-0 left-0 right-0 w-full h-full flex flex-row items-center pl-10'>
                    <div className=' flex flex-col'>
                        <h3 className='text-5xl text-dark_jungle_green font-semibold'>Product Discover</h3>
                        <h1 className='text-8xl text-dark_jungle_green font-semibold'>Diabivita</h1>
                        <h4 className='text-3xl text-dark_jungle_green font-normal'>YOUR WELLNES COMANION</h4>
                        <p className='text-2xl mt-2 w-[500px] text-charcoal_black font-semibold'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nihil deserunt id quod ducimus consequatur rem sunt cum, dolorum fugiat sit quasi fuga quo doloribus laboriosam dolores unde, adipisci ullam vero?</p>
                    </div>
                </div>
            </div>
            <div className=' absolute  left-0 right-8 bottom-1 flex flex-row'>
                <div className='w-full h-[700px] flex flex-row items-end bg-transparent pl-10'>
                    <div className=' w-[600px] mt-auto '>
                        <h1 className='text-7xl text-dark_jungle_green font-semibold'>Your New Daily Ritual</h1>
